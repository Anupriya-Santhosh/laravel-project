        ...
        <div class="row">
            ...
            <div class="col-md-9 col-lg-10 main-content">
                ...
                <main class="d-flex justify-content-center align-items-center" style="min-height: 80vh;">
                    ...
                    <h4 class="text-center mb-4">Add Feature Destination</h4>
...
<form action="{{ route('store_destination') }}" method="POST" enctype="multipart/form-data">
    ...
    <div class="mb-3">
        ...
        <input type="text" id="title" name="title" class="form-control" placeholder="Destination Title" required>
    </div>
    <div class="mb-3">
        <label for="description" class="form-label">Description</label>
        <textarea id="description" name="description" class="form-control" rows="4" placeholder="Description" required></textarea>
    </div>
    <div class="mb-3">
